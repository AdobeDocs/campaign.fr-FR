...
+ Mises à niveau{#tn-new}
   ...
   + [Mise à niveau de l’infrastructure d’envoi de courriers électroniques de Campaign](upgrades/migration-to-aws.md)
   ...
   + [Dépréciation de la console cliente 32 bits](upgrades/console.md)
