...
| deliveryPartRetryDelaySeconds | Délai minimum avant de retenter un deliveryPart. Il s’agit d’un processus et d’un conteneur croisés. Le délai est en secondes. | 60 | 0 : reprises immédiates | 3600 : reprises très lentes (1 heure entre chaque reprise) | 1 : facilite le suivi des reprises dans les logs occupés. |
...
| providerIdThreads | Nombre de threads pour la réconciliation de l&#39;identifiant du fournisseur. 1 thread par instance suffit. Définissez sur 0 pour désactiver sur ce conteneur. | 1 | 0 : désactiver sur ce conteneur | 1 | 1 |
