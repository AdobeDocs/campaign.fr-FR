...
* Stocker une copie (h+1) des tables de référence (telles que les diffusions, les énumérations, les pays, etc.) utilisés dans les workflows, les campagnes et les rapports.
