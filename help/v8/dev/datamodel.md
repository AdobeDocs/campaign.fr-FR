...
>[!NOTE]
>
>Pour accéder à la description de chaque tableau, accédez à la section **Administration > Paramétrage > Schémas de données**, sélectionnez une ressource dans la liste, puis cliquez sur l’icône **Documentation** .
