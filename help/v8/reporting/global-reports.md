...
* **[!UICONTROL Débit de diffusion]** : voir [Débit de diffusion](#delivery-throughput).
...
* **[!UICONTROL Echecs et retours]** : voir [Echecs et retours](#non-deliverables-and-bounces).
