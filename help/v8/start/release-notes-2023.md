...
* Correction d’un problème qui empêchait le workflow de nettoyage de la base de données de supprimer des adresses dans la table nms:address sur FFDA. (NEO-54460)
...
* Correction d’un problème qui entraînait des erreurs lors de l’utilisation du connecteur BigQuery avec les champs dateTime. (NEO-49768)


## Version 8.4.5 {#release-8-4-5}

_mardi 3 avril 2023_
...
* La gestion des données de tracking consolidées a été améliorée dans la table FFDA **[!UICONTROL Tracking consolidé]** (nms:trackingStats) afin d’éviter les doublons. (NEO-46409)
