...
[!DNL :bulb:] En savoir plus sur la segmentation, et la création et la personnalisation d&#39;audiences dans [cette section](audiences.md).
...
[!DNL :bulb:] En savoir plus sur les fonctionnalités de reporting et de tracking dans [cette section](reporting.md).
