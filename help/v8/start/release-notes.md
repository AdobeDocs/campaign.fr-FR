...
* Le fichier setup-client.exe a été remplacé par un fichier ac-client.msi. Cela permet aux administrateurs d’effectuer plus facilement des mises à niveau en masse sans intervention de l’utilisateur.
