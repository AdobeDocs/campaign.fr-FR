...
* Vous ne pouvez plus créer d’opérateurs à partir de la console cliente. Vous devez désormais utiliser Admin Console. [En savoir plus](../start/gs-permissions.md).
