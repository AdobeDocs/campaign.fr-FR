...
Cette page répertorie les problèmes connus identifiés dans la **dernière version de Campaign v8**. En outre, les limites de Campaign v8 sont répertoriées sur [cette page](known-limitations.md).
