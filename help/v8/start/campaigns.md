...
* **Programme** : un programme vous permet de définir des actions marketing pour une période calendaire, notamment le lancement, le démarchage, la fidélité, etc. Chaque programme contient des campagnes liées à un calendrier, qui fournit une vue globale.
...
1. **Création de diffusions**
   ...
   Vous pouvez associer différents documents à une opération, comme des rapports, photos, pages web, diagrammes, etc. En savoir plus sur les documents associés dans [cette page](../../automation/campaigns/marketing-campaign-assets.md).
