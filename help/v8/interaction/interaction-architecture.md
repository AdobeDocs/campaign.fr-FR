...
Ces deux types d&#39;interactions peuvent être réalisés soit en **mode unitaire** (l&#39;offre est calculée pour un seul contact), ou dans **mode batch** (l&#39;offre est calculée pour un ensemble de contacts). Généralement, les interactions entrantes sont réalisées en mode unitaire et les interactions sortantes en mode batch. Néanmoins, il peut y avoir certaines exceptions : [messages transactionnels](../send/transactional.md) par exemple, où l&#39;interaction sortante est réalisée en mode unitaire.
...
1. Créez un compte externe par instance d&#39;exécution :
   ...
   * Chaque instance d&#39;exécution doit être associée à un identifiant. Cet identifiant est attribué lorsque vous cliquez sur le **[!UICONTROL Initialiser la connexion]** Bouton.
