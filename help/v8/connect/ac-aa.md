...
[!DNL :speech_balloon:] En tant qu&#39;utilisateur Managed Cloud Services, [contactez Adobe](../start/campaign-faq.md#support) pour connecter Campaign aux services et solutions Adobe Experience Cloud. Adobe Identity Management Service (IMS) doit être mis en oeuvre pour votre instance. [En savoir plus](../start/connect.md#connect-ims). Le module complémentaire de connecteur Web Analytics doit être installé sur votre environnement, via le package dédié.
