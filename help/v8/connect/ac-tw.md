...
![](../assets/do-not-localize/speech.png) En tant qu’utilisateur ou utilisatrice de Managed Cloud Services, [contactez Adobe](../start/campaign-faq.md#support) pour connecter Campaign à X. Le module complémentaire **Gestion des réseaux sociaux (Social Marketing)** doit être installé sur votre environnement, par le biais du module dédié, et le compte externe Twitter doit être configuré.
...
1. Connectez-vous au [Portail de développement X](https://developer.twitter.com/en/apps).
