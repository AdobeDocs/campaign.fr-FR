...
Pour qu’Adobe Campaign effectue la publication, vous devez créer un workflow adéquat et le lier à la ressource. Pour ce faire, ouvrez la boîte **[!UICONTROL Paramètres avancés...]** de la ressource, puis sélectionnez le workflow désiré dans le champ **[!UICONTROL Post-traitement]**.
