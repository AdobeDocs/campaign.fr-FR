...
1. Renseignez le modèle et le nom de la simulation. Clic **[!UICONTROL Enregistrer]** pour créer la simulation.
...
1. Dans le **[!UICONTROL Portée]** spécifiez les diffusions à prendre en compte pour cette simulation. Pour ce faire, cliquez sur le lien **[!UICONTROL Ajouter]** et indiquez le mode de sélection des diffusions à prendre en compte.
   ...
   >[!NOTE]
   >
   >Si vous sélectionnez les diffusions d&#39;un plan, d&#39;un programme ou d&#39;une opération, Adobe Campaign peut actualiser automatiquement la liste des diffusions à prendre en compte à chaque lancement de la simulation. Pour ce faire, vérifiez le **[!UICONTROL Actualiser la sélection des diffusions à chaque démarrage de la simulation]** option.
   >  
...
1. Sélectionnez les éléments à inclure dans le périmètre de la simulation. Au besoin, vous pouvez effectuer une multi-sélection en utilisant les touches MAJ et CTRL du clavier.
   ...
   Si nécessaire, vous pouvez utiliser une condition dynamique via l&#39;icône **[!UICONTROL Modifier la condition dynamique...]** lien.
...
* **[!UICONTROL Enregistrer les requêtes SQL dans le journal]**. Les logs SQL permettent de diagnostiquer une simulation si elle se termine par une erreur. Ils peuvent également vous aider à comprendre pourquoi une simulation est trop lente. Ces messages seront visibles après la simulation dans le **[!UICONTROL Logs SQL]** sous-onglet du **[!UICONTROL Audit]** onglet.
...
Le **[!UICONTROL Audit]** permet de suivre l&#39;exécution de la simulation. Le **[!UICONTROL Journaux SQL]** Le sous-onglet est utile pour les utilisateurs experts. Il répertorie les journaux d’exécution au format SQL. Ces journaux ne s’affichent que si **[!UICONTROL Enregistrer les requêtes SQL dans le journal]** a été sélectionnée dans **[!UICONTROL Général]** avant l&#39;exécution de la simulation.
...
Les indicateurs dans le **[!UICONTROL Log]** et **[!UICONTROL Résultats]** Les onglets offrent un premier aperçu des résultats de la simulation. Pour obtenir une vue plus détaillée des résultats, ouvrez le . **[!UICONTROL Rapports]** onglet.
