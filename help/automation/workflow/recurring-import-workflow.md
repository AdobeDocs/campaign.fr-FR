...
Cet exemple montre comment pré-paramétrer un workflow qui pourra être réutilisé pour importer des profils en provenance d’un CRM dans la base de données Adobe Campaign. Pour plus d’informations sur tous les paramètres possibles pour chaque activité, consultez cette [section](activities.md).
