...
1. Configurez l&#39;activité **[!UICONTROL Mise à jour de données]** située après la première transition sortante de l&#39;activité **[!UICONTROL Partage]** paramétrée précédemment.
   ...
   * Dans le **[!UICONTROL Identification des enregistrements]** , sélectionnez **[!UICONTROL Utiliser les clés de réconciliation]** et définissez une clé entre la dimension de ciblage et le lien créé dans la **[!UICONTROL Enrichissement]**. Dans cet exemple, le champ personnalisé **Identifiant dans le CRM** est utilisé.
...
Le modèle est à présent utilisable et disponible pour chaque nouveau workflow. Il suffit ensuite de spécifier le fichier contenant les données à importer dans le **[!UICONTROL Chargement (fichier)]** activité.
