...
* [Envoi d’un e-mail d’anniversaire](send-a-birthday-email.md)
* [Charger le contenu de la diffusion](load-delivery-content.md)
...
* [Coordonner les mises à jour de données](coordinate-data-updates.md)
...
* [Effectuer une requête sur la table des destinataires](querying-recipient-table.md)
* [Informations sur la diffusion de requêtes](query-delivery-info.md)
* [Effectuer un calcul d&#39;agrégats](compute-aggregates.md)
* [Exécuter des requêtes avec gestion des regroupements](query-grouping-management.md)
...
* [Filtrer les destinataires en double](filter-duplicated-recipients.md)
