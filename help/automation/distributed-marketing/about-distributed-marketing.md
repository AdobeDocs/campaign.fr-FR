...
* **Opération collaborative**
   ...
   * **[!UICONTROL Opération collaborative (par opération)]**: recommandé pour les campagnes visant des dizaines d’entités locales. Ce type d&#39;opération crée des opérations filles pour chaque entité locale. Une fois le **[!UICONTROL opération collaborative (par opération)]** validée par l&#39;entité centrale, l&#39;opération est mise à disposition de l&#39;entité locale qui peut la modifier. L’exécution est automatiquement synchronisée entre les campagnes parents et enfants. L&#39;entité locale doit avoir accès à une instance pour commander une opération et y participer.
...
Chaque entité organisationnelle contient des informations d&#39;identification (libellé, nom interne, coordonnées, etc.) et des groupes impliqués dans le processus de validation de la commande. Ils sont définis dans le **[!UICONTROL Notifications et validations]** section trouvée dans **[!UICONTROL Général]** onglet.
